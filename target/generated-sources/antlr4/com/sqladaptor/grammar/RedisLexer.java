...
public class RedisLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"O", "P", "Q", "R", "S", "T", "U", "V", "W", "X", "Y", "Z", "GET", "SET", 
			"GETRANGE", "GETSET", "GETBIT", "MGET", "SETBIT", "SETEX", "SETNX", "SETRANGE", 
			"STRLEN", "MSET", "MSETNX", "PSETEX", "INCR", "INCRBY", "INCRBYFLOAT", 
			"DECR", "DECRBY", "APPEND", "HGET", "HSET", "HDEL", "HGETALL", "HKEYS", 
			"HVALS", "HEXISTS", "HINCRBY", "HLEN", "LPUSH", "RPUSH", "LPOP", "RPOP", 
			"LLEN", "LRANGE", "BLPOP", "BRPOP", "BRPOPLPUSH", "LINDEX", "LINSERT", 
			"LPUSHX", "LREM", "LSET", "LTRIM", "RPOPLPUSH", "RPUSHX", "SADD", "SREM", 
			"SMEMBERS", "SCARD", "SISMEMBER", "SINTER", "SINTERSTORE", "SUNION", 
			"SUNIONSTORE", "SDIFF", "SDIFFSTORE", "SMOVE", "SPOP", "SRANDMEMBER", 
			"SSCAN", "ZADD", "ZREM", "ZRANGE", "ZCARD", "ZSCORE", "ZCOUNT", "ZINCRBY", 
			"ZINTERSTORE", "ZLEXCOUNT", "ZRANGEBYLEX", "ZRANGEBYSCORE", "ZRANK", 
	...
	public RedisLexer(CharStream input) {
		super(input);
